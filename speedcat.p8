            ...
            if ( (xdist < xwidths) and (ydist < ywidths) ) then
                if (horiz) then
                    if (closest == nil) or (closest.xdist > xdist) then
                        if (o.type ~= 'teleporter') or (o.active) then
                            closest = o
                            closest.xdist = xdist
                        end
                    end
...
function init_first_room()
    ...
    room_num = 11 -- change this to set the first spawn room
...

