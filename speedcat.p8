...
function init_main_menu()
    ...
    main_menu.init = function(this)
        ...
        for opt in all(this.options) do
            ...
            if (new_opt.message == "timers on") and (timers == false) then
                new_opt.message = "timers off"
            end
...

